...
<body>
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-7">
                                    <h5 class="mb-3"><a href="http://127.0.0.1:8000" class="text-body"><i
                                                class="fas fa-long-arrow-alt-left me-2" href="http://127.0.0.1:8000/home"></i>Continue shopping</a></h5>
                                    <hr>
                                            ...
                                            <div class="card-body">
                                                <div class="d-flex justify-content-between">
                                                    <div class="d-flex flex-row align-items-center">
                                                        <div>
                                                            <img src="{{ asset('images') }}/{{$cart->product->slide_url}}"
    ...
    <!-- <div class="container mt-5">
        <h1>Your Cart</h1> -->
    <!-- Hiển thị nội dung giỏ hàng ở đây -->
    <!-- <div>
